...
for i, nombre in enumerate(nombres_diapo):
    # Resaltar la diapositiva actual cambiando el tipo de botón
...
# ==============================================================================
# DIAPOSITIVA 5: RESULTADOS Y ANÁLISIS DE FONDO (CON GRÁFICAS ACLARADAS)
# ==============================================================================
    ...
    # 1. ANÁLISIS DE LA CURVA DEL CODO (FONDO COMPLETAMENTE ACLARADO)
    ...
    # Ajuste quirúrgico de fondo claro
    ...
    # 2. ANÁLISIS DE DISTANCIAS Y DISIMILITUDES (FONDO COMPLETAMENTE ACLARADO)
    ...
    st.markdown("""
    <div class='insight-card'>
        <b>🔍 Análisis del Mapa de Calor:</b> Los bloques oscuros identifican municipios con perfiles de conflicto idénticos (baja distancia entre sí), mientras que los cambios abruptos de color revelan contrastes operacionales radicales, aislando zonas tranquilas de aquellas con dinámicas complejas.
    </div>
    """, unsafe_allow_html=True)

    # 3. ANÁLISIS TRIDIMENSIONAL DE PCA Y DATOS ATÍPICOS (CUBOS Y PAREDES ACLARADAS AL MÁXIMO)
    ...
    # MÁXIMA CLARIDAD EN LA ESCENA 3D: Eliminación de paredes grises y rejillas oscuras
    fig_3d.update_layout(
        paper_bgcolor='white',  # Contenedor exterior blanco puro
        scene=dict(
            ...
            bgcolor="white"     # Fondo interno del cubo 3D blanco puro
        ),
    ...
    <div class='slide-container'>
        ...
        <ul>
            ...
            <li><b>🔵 Clúster 1 (Impacto Moderado / Dinámico):</b> Municipios que muestran activity delictiva constante pero con baja letalidad. Son zonas con novedades frecuentes (heridos o afectaciones logísticas) pero donde la confrontación armada no está desbordada.</li>
